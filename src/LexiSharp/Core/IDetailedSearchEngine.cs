...
/// <see cref="ITextSearchEngine.Search"/> contract. It is naturally implemented by federated
...
{
    /// <summary>
    /// Same search as <see cref="ITextSearchEngine.Search"/>, but every result also carries the
